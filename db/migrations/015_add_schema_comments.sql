-- 为所有核心表及字段添加业务注释
-- 便于通过数据库 UI 工具（如 pgAdmin、DataGrip、Navicat）直接查看字段含义与数据来源
...
-- 15. seed_growth_alerts (种子粉丝量大幅增长提醒)
...
-- 16. creator_snapshots (普通创作者粉丝历史快照)
...
-- 17. seed_follower_snapshots (种子创作者粉丝历史快照)
